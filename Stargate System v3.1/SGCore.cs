...
namespace Server.SG
{
    public class SGCore
    {
        ...
        public static void SGEnterTest()
        {
            ...
            SGList.Add(new SGEntry(false, 5480, 1172, 0, "E", 1, true, false, false, false, "Nobody", "Test Gate 1", 1, 1, 1, 1, 1, 1));
            SGList.Add(new SGEntry(false, 5480, 1179, 0, "E", 1, true, false, false, false, "Nobody", "Test Gate 2", 1, 1, 1, 1, 1, 2));
            SGList.Add(new SGEntry(false, 5487, 1172, 0, "S", 1, true, false, false, false, "Nobody", "Test Gate 3", 1, 1, 1, 1, 1, 3));
            SGList.Add(new SGEntry(false, 5487, 1179, 0, "S", 1, true, false, false, false, "Nobody", "Test Gate 4", 1, 1, 1, 1, 1, 4));
        }
        ...
        public static void SGLoadFile(string FilePath)
        {
            try
            {
                ...
                {
                    if (!bool.TryParse(StargateEntry.SelectSingleNode("SGHideDial").InnerText, out SGHideDialIn))//use TryParse
                    {
                    ...
                    SGList.Add(new SGEntry(SGHideDialIn, SGXIn, SGYIn, SGZIn, SGFacingIn, SGStyleIn, SGCanBeUsedIn, SGBeingUsedIn, SGEnergyIn, SGHiddenIn, SGDiscoveredIn, SGLocationNameIn, SGFacetCodeIn, SGAddressCode1In, SGAddressCode2In, SGAddressCode3In, SGAddressCode4In, SGAddressCode5In));
                }
        ...
        public static void SGWorldBuild()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < SGList.Count; i++)
                {
                    ...
                    {
                        // Build a HIDDEN DIALER
                        if (sgwb.SGFacetCode == 1)
                        {
                            Item SGACrystal = new SGActivatorDevice(sgwb.SGHideDial, sgwb.SGX, sgwb.SGY, sgwb.SGZ, sgwb.SGFacing, sgwb.SGStyle, sgwb.SGCanBeUsed, sgwb.SGBeingUsed, sgwb.SGEnergy, sgwb.SGHidden, sgwb.SGDiscovered, sgwb.SGLocationName, sgwb.SGFacetCode, sgwb.SGAddressCode1, sgwb.SGAddressCode2, sgwb.SGAddressCode3, sgwb.SGAddressCode4, sgwb.SGAddressCode5);
                            SGACrystal.Visible = false;
                            SGACrystal.MoveToWorld(new Point3D(sgwb.SGX, sgwb.SGY, sgwb.SGZ + 30), Map.Felucca);
                        }
                        else if (sgwb.SGFacetCode == 2)
                        {
                            Item SGACrystal = new SGActivatorDevice(sgwb.SGHideDial, sgwb.SGX, sgwb.SGY, sgwb.SGZ, sgwb.SGFacing, sgwb.SGStyle, sgwb.SGCanBeUsed, sgwb.SGBeingUsed, sgwb.SGEnergy, sgwb.SGHidden, sgwb.SGDiscovered, sgwb.SGLocationName, sgwb.SGFacetCode, sgwb.SGAddressCode1, sgwb.SGAddressCode2, sgwb.SGAddressCode3, sgwb.SGAddressCode4, sgwb.SGAddressCode5);
                            SGACrystal.Visible = false;
                            SGACrystal.MoveToWorld(new Point3D(sgwb.SGX, sgwb.SGY, sgwb.SGZ + 30), Map.Trammel);
                        }
                        else if (sgwb.SGFacetCode == 3)
                        {
                            Item SGACrystal = new SGActivatorDevice(sgwb.SGHideDial, sgwb.SGX, sgwb.SGY, sgwb.SGZ, sgwb.SGFacing, sgwb.SGStyle, sgwb.SGCanBeUsed, sgwb.SGBeingUsed, sgwb.SGEnergy, sgwb.SGHidden, sgwb.SGDiscovered, sgwb.SGLocationName, sgwb.SGFacetCode, sgwb.SGAddressCode1, sgwb.SGAddressCode2, sgwb.SGAddressCode3, sgwb.SGAddressCode4, sgwb.SGAddressCode5);
                            SGACrystal.Visible = false;
                            SGACrystal.MoveToWorld(new Point3D(sgwb.SGX, sgwb.SGY, sgwb.SGZ + 30), Map.Ilshenar);
                        }
                        else if (sgwb.SGFacetCode == 4)
                        {
                            Item SGACrystal = new SGActivatorDevice(sgwb.SGHideDial, sgwb.SGX, sgwb.SGY, sgwb.SGZ, sgwb.SGFacing, sgwb.SGStyle, sgwb.SGCanBeUsed, sgwb.SGBeingUsed, sgwb.SGEnergy, sgwb.SGHidden, sgwb.SGDiscovered, sgwb.SGLocationName, sgwb.SGFacetCode, sgwb.SGAddressCode1, sgwb.SGAddressCode2, sgwb.SGAddressCode3, sgwb.SGAddressCode4, sgwb.SGAddressCode5);
                            SGACrystal.Visible = false; 
                            SGACrystal.MoveToWorld(new Point3D(sgwb.SGX, sgwb.SGY, sgwb.SGZ + 30), Map.Malas);
                        }
                        else if (sgwb.SGFacetCode == 5)
                        {
                            Item SGACrystal = new SGActivatorDevice(sgwb.SGHideDial, sgwb.SGX, sgwb.SGY, sgwb.SGZ, sgwb.SGFacing, sgwb.SGStyle, sgwb.SGCanBeUsed, sgwb.SGBeingUsed, sgwb.SGEnergy, sgwb.SGHidden, sgwb.SGDiscovered, sgwb.SGLocationName, sgwb.SGFacetCode, sgwb.SGAddressCode1, sgwb.SGAddressCode2, sgwb.SGAddressCode3, sgwb.SGAddressCode4, sgwb.SGAddressCode5);
                            SGACrystal.Visible = false;
                            SGACrystal.MoveToWorld(new Point3D(sgwb.SGX, sgwb.SGY, sgwb.SGZ + 30), Map.Tokuno);
                        }
        ...
        public static void SGSaveFile(string FilePath)
        {
            ...
            foreach (SGEntry entry in SGList)
            {
                ...
                XmlNode SGHideDial = doc.CreateNode(XmlNodeType.Element, "SGHideDial", "");
                SGHideDial.InnerText = entry.SGHideDial.ToString();
