...
namespace Server.SG
{
    ...
    {
        public bool m_SGAHideDial = false;
        ...
        public bool SGAHideDial
        { get { return m_SGAHideDial; } set { m_SGAHideDial = value; } }
        ...
        [Constructable]
        public SGActivatorDevice(bool sgahidedial, int sgaxloc, int sgayloc, int sgazloc, string sgafacing, int sgastyle, bool canbeused, bool beingused, bool energy, bool hidden, string discover, string locname, int facetID, int sgac1, int sgac2, int sgac3, int sgac4, int sgac5) : base(13803)
        {
            m_SGAHideDial = sgahidedial;
            m_SGAXloc = sgaxloc;
            m_SGAYloc = sgayloc;
            m_SGAZloc = sgazloc;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write((bool)m_SGAHideDial);
