...
namespace Server.SG
{
    ...
    {
        private bool m_SGHideDial;
        public bool SGHideDial
        { get { return m_SGHideDial; } set { m_SGHideDial = value; } }
        ...
        public SGEntry(bool sghidedial, int sgx, int sgy, int sgz, string sgfacing, int sgstyle, bool sgcanbeused, bool sgbeingused, bool sgenergy, bool sghidden, string sgdiscovered, string sglocationname, int sgfacetcode, int sgaddresscode1, int sgaddresscode2, int sgaddresscode3, int sgaddresscode4, int sgaddresscode5)
        {
            m_SGHideDial = sghidedial;
            m_SGX = sgx;
            m_SGY = sgy;
            m_SGZ = sgz;
            m_SGFacing = sgfacing;
